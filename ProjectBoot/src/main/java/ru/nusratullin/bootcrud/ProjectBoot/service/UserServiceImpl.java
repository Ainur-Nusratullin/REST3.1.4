                ...
                .map(roleName -> {
                    ...
                    if (existingRole.isPresent()) {
                       ...
                       ////////////////////////////////////////
                        Optional.empty
                      ////////////////////////////////////////
                      при первом вхождении, в бд нет ролей
                      и после userDao.save(user) благодаря каскаду создаются роли в бд
                      а затем чтобы не дублировать роли в бд
                      в блоке if идет проверка есть ли эта роль в бд.
                      так же если в User убираю каскадность приложение падает
                         */
                    }
                })
